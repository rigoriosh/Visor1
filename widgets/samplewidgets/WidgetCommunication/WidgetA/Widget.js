...
define(["dojo/_base/declare", "dojo/_base/lang", "jimu/BaseWidget"], function (
  ...
  return b([d], {
    ...
    _onPublishClick: function () {
      this.publishData({ message: "I am widget A." });
      this.i++;
      this.pubInfoNode.innerText = "Publish " + this.i;
    },
    _onPublishHisClick: function () {
      this.publishData({ message: "I am widget A." }, !0);
      this.j++;
      ...
      0 === a.length
        ...
        : ((a = a[0].id),
          this.widgetManager.getWidgetById(a)
            ...
            : this.openWidgetById(a).then(
                c.hitch(this, function (e) {
                  this.loadWidgetBInfoNode.innerText = e.name + " is loaded";
                })
              ));
    },
  });
